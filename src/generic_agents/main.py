#!/usr/bin/env python
import sys
from generic_agents.crew import GenericAgentsCrew
...
"""
    ...
    GenericAgentsCrew().crew().kickoff(inputs=inputs)
...
"""
    ...
    try:
        GenericAgentsCrew().crew().train(n_iterations=int(sys.argv[1]), inputs=inputs)
